import{r as i,j as e}from"./iframe-BwwGkoIt.js";import{u as a,M as p}from"./blocks-CssbAMCn.js";import{c as v}from"./game-event-bus-CVIPXPct.js";import{B as r}from"./button-BLirxb1W.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Y6rBIlSp.js";import"./index-CE-hBTDb.js";import"./index-B8nmnmTn.js";import"./index-224OW_Ue.js";import"./index-DrFu-skq.js";import"./utils-BQHNewu7.js";import"./index-DVcT2Q-Y.js";const c={gameId:"demo",sessionId:"demo-session",profileId:"anonymous",timestamp:Date.now(),roundIndex:0},l=()=>{const t=i.useRef(v()),[n,m]=i.useState([]);i.useEffect(()=>t.current.subscribe("game:*",o=>{m(j=>[`[${o.type}] ${JSON.stringify(o)}`,...j.slice(0,9)])}),[]);const u=()=>{const s={type:"game:start",...c,locale:"en",difficulty:"easy",gradeBand:"k"};t.current.emit(s)},h=()=>{const s={type:"game:end",...c,finalScore:0,totalRounds:1,correctCount:0,durationMs:0};t.current.emit(s)},x=()=>{const s={type:"game:instructions_shown",...c};t.current.emit(s)};return e.jsxs("div",{className:"flex flex-col gap-4 p-4",children:[e.jsxs("div",{className:"flex flex-wrap gap-2",children:[e.jsx(r,{size:"sm",onClick:u,children:"Emit game:start"}),e.jsx(r,{size:"sm",onClick:h,children:"Emit game:end"}),e.jsx(r,{size:"sm",onClick:x,children:"Emit game:instructions_shown"})]}),e.jsx("div",{className:"rounded border p-2 font-mono text-xs",children:n.length===0?e.jsx("span",{className:"text-muted-foreground",children:"No events yet — click a button above."}):n.map(s=>e.jsx("div",{children:s},s))})]})};l.__docgenInfo={description:"",methods:[],displayName:"GameEventBusDemo"};function d(t){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,e.jsx(p,{title:"Services/GameEventBus"}),`
...
`]}),`
`,e.jsx(n.h2,{id:"interactive-demo",children:"Interactive Demo"}),e.jsx(l,{})]})}function N(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(d,{...t})}):d(t)}export{N as default};
