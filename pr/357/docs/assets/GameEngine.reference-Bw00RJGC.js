import{j as e}from"./iframe-C1Q3LWME.js";import{u as i,M as r}from"./blocks-DvwZPW1i.js";import"./preload-helper-PPVm8Dsz.js";import"./index-kxRrcmdt.js";import"./index-DhzqVXYw.js";import"./index-BvXyGqqa.js";import"./index-5K2bJQjX.js";import"./index-DrFu-skq.js";function s(d){const n={blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i(),...d.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"GameEngine/Reference"}),`
...
`,e.jsxs(n.p,{children:[`
  `,e.jsx(n.code,{children:"buildEngineGuards(totalRounds, levelSize)"}),` returns the runtime bodies
  for the placeholder guards declared in each game's `,e.jsx(n.code,{children:"setup({ guards })"}),`:
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`isMidLevelRound: ({ context }) =>
  (context.roundIndex + 1) % max(levelSize, 1) !== 0 &&
  context.roundIndex + 1 < totalRounds;
