import{w as se}from"./withDb-DaVzNHjw.js";import{c as te,b as oe,w as re}from"./withRouter-X25i_yyG.js";import{b as U,c as P}from"./sort-numbers-level-generator-CE-KkRP3.js";import{r as d,j as n}from"./iframe-oWEQ74uG.js";import{S as ae}from"./SortNumbersTileBank-DvjtPYmz.js";import{A}from"./AnswerGame-B7pbDyZS.js";import{G as ie}from"./GameOverOverlay-DroTLTjA.js";import{L as ce}from"./LevelCompleteOverlay-BcWxZnks.js";import{S as de}from"./ScoreAnimation-6v-7RwLJ.js";import{S as le,a as ue}from"./SlotRow-fItr-G1C.js";import{g as me}from"./tile-font-DQ9RrPM_.js";import{a as pe,u as ge}from"./AnswerGameProvider-0Cyx5-wi.js";import{b as fe,u as xe,a as Me}from"./build-round-order-DcZCLv8x.js";import{u as be}from"./useTranslation-DcdI7xXf.js";import"./DbProvider-DlXAhyFL.js";import"./index.browser-BY9c7rfI.js";import"./Subject-VZNLZCXQ.js";import"./tslib.es6--Hu8dhvm.js";import"./index-Cv5-28l5.js";import"./index-C1VkwZ2e.js";import"./index-CexROuzl.js";import"./preload-helper-PPVm8Dsz.js";import"./useTouchDrag-BWezud-i.js";import"./useDraggableTile-gs2bidDq.js";import"./useGameTTS-FRV4Bf45.js";import"./useSettings-DmON4ymd.js";import"./useRxDB-D1iHOsEW.js";import"./useRxQuery-BxfbzSeZ.js";import"./SpeechOutput-By2uxF-i.js";import"./confetti.module-oQXWb4Lk.js";import"./AudioFeedback-cxEhBYIg.js";import"./game-event-bus-CVIPXPct.js";import"./GameRoundContext-z4ASo3Mg.js";const ve=({sortNumbersConfig:e,roundOrder:o,onRestartSession:j})=>{const{t:l}=be("games"),{phase:u,roundIndex:r,retryCount:G,zones:g,levelIndex:m}=pe(),t=ge(),{confettiReady:a,levelCompleteReady:f,gameOverReady:O}=xe(),p=te(),{locale:H}=oe({from:"/$locale"}),_=d.useRef(0),V=o[r],Z=V===void 0?void 0:e.rounds[V],z=e.direction==="ascending"?l("sort-numbers-ui.ascending-label"):l("sort-numbers-ui.descending-label");Me(z);const K=()=>{p({to:"/$locale",params:{locale:H}})},Q=()=>{j()},J=()=>{const i=e.levelMode?.generateNextLevel;if(!i)return;const c=i(m);t(c?{type:"ADVANCE_LEVEL",tiles:c.tiles,zones:c.zones}:{type:"COMPLETE_GAME"})},X=()=>{t({type:"COMPLETE_GAME"})};return d.useEffect(()=>{if(u!=="round-complete"||!a)return;const i=++_.current,x=globalThis.setTimeout(()=>{if(_.current!==i)return;if(r>=o.length-1){t({type:"COMPLETE_GAME"});return}const F=o[r+1],W=F===void 0?void 0:e.rounds[F];if(!W){t({type:"COMPLETE_GAME"});return}const Y=e.tileBankMode==="distractors"?{config:e.distractors,range:e.range}:void 0,{tiles:ee,zones:ne}=U(W.sequence,e.direction,Y);t({type:"ADVANCE_ROUND",tiles:ee,zones:ne})},750);return()=>{globalThis.clearTimeout(x)}},[u,a,r,t,o,e.rounds,e.direction,e.tileBankMode,e.distractors,e.range]),Z?n.jsxs(n.Fragment,{children:[n.jsxs("div",{className:"flex w-full max-w-4xl flex-col items-center justify-center gap-8 px-4 py-6",children:[n.jsx(A.Question,{children:n.jsx("p",{className:"text-center text-lg font-semibold text-foreground",children:z})}),n.jsx(A.Answer,{children:n.jsx(le,{className:"gap-2",children:g.map((i,c)=>n.jsx(ue,{index:c,className:"size-14 rounded-lg",children:({label:x})=>n.jsx("span",{className:`${me(x?.length??0,56)} font-bold tabular-nums`,children:x})},i.id))})}),n.jsx(A.Choices,{children:n.jsx(ae,{})})]}),n.jsx(de,{visible:a}),f?n.jsx(ce,{level:m+1,onNextLevel:J,onDone:X}):null,O?n.jsx(ie,{retryCount:G,onPlayAgain:Q,onHome:K}):null]}):null},$=({config:e,initialState:o,sessionId:j,seed:l})=>{const u=e.roundsInOrder===!0,[r,G]=d.useState(0),g=d.useMemo(()=>fe(e.rounds.length,u,l),[e.rounds.length,u,l,r]),m=g[0],t=m===void 0?void 0:e.rounds[m],{tiles:a,zones:f}=d.useMemo(()=>{if(!t)return{tiles:[],zones:[]};const p=e.tileBankMode==="distractors"?{config:e.distractors,range:e.range}:void 0;return U(t.sequence,e.direction,p)},[t,e.direction,e.tileBankMode,e.distractors,e.range]),O=d.useMemo(()=>({gameId:e.gameId,inputMethod:e.inputMethod,wrongTileBehavior:e.wrongTileBehavior,tileBankMode:e.tileBankMode,totalRounds:e.rounds.length,roundsInOrder:e.roundsInOrder,ttsEnabled:e.ttsEnabled,touchKeyboardInputMode:"numeric",initialTiles:a,initialZones:f,slotInteraction:"free-swap",levelMode:e.levelMode}),[e.gameId,e.inputMethod,e.wrongTileBehavior,e.tileBankMode,e.rounds.length,e.roundsInOrder,e.ttsEnabled,e.levelMode,a,f]);return t?n.jsx(A,{config:O,initialState:o,sessionId:j,children:n.jsx(ve,{sortNumbersConfig:e,roundOrder:g,onRestartSession:()=>{G(p=>p+1)}})}):null};$.__docgenInfo={description:"",methods:[],displayName:"SortNumbers",props:{config:{required:!0,tsType:{name:"SortNumbersConfig"},description:""},initialState:{required:!1,tsType:{name:"AnswerGameDraftState"},description:""},sessionId:{required:!1,tsType:{name:"string"},description:""},seed:{required:!1,tsType:{name:"string"},description:""}}};const s={gameId:"sort-numbers",component:"SortNumbers",inputMethod:"drag",wrongTileBehavior:"lock-manual",tileBankMode:"exact",totalRounds:3,roundsInOrder:!1,ttsEnabled:!1,direction:"ascending",range:{min:2,max:20},quantity:4,skip:{mode:"consecutive"},distractors:{source:"random",count:2},rounds:[{sequence:[3,4,5,6]},{sequence:[7,8,9,10]},{sequence:[11,12,13,14]}]},en={component:$,tags:["autodocs"],decorators:[se,re],args:{config:s}},M={},b={args:{config:{...s,skip:{mode:"by",step:3,start:"range-min"},rounds:[{sequence:[2,5,8,11]},{sequence:[2,5,8,11]},{sequence:[2,5,8,11]}]}}},v={args:{config:{...s,skip:{mode:"random"},rounds:[{sequence:[2,7,12,18]},{sequence:[3,6,11,15]},{sequence:[4,9,14,20]}]}}},y={args:{config:{...s,tileBankMode:"distractors",distractors:{source:"random",count:3}}}},S={args:{config:{...s,skip:{mode:"by",step:2,start:"range-min"},tileBankMode:"distractors",distractors:{source:"gaps-only",count:"all"},rounds:[{sequence:[2,4,6,8]},{sequence:[2,4,6,8]},{sequence:[2,4,6,8]}]}}},q={args:{config:{...s,tileBankMode:"distractors",distractors:{source:"full-range",count:4}}}},L={args:{config:{...s,configMode:"simple",direction:"ascending",quantity:5,skip:{mode:"by",step:2,start:2},range:{min:2,max:10},tileBankMode:"exact",totalRounds:1,rounds:[{sequence:[2,4,6,8,10]}]}}},k={args:{config:{...s,configMode:"simple",direction:"ascending",quantity:5,skip:{mode:"by",step:2,start:2},range:{min:2,max:10},tileBankMode:"distractors",distractors:{source:"gaps-only",count:"all"},totalRounds:1,rounds:[{sequence:[2,4,6,8,10]}]}}},h={args:{config:{...s,configMode:"simple",direction:"descending",quantity:5,skip:{mode:"by",step:2,start:2},range:{min:2,max:10},tileBankMode:"exact",totalRounds:1,rounds:[{sequence:[2,4,6,8,10]}]}}},R={args:{config:{...s,configMode:"advanced",skip:{mode:"by",step:2,start:3},range:{min:1,max:20},rounds:[{sequence:[3,5,7,9]},{sequence:[3,5,7,9]},{sequence:[3,5,7,9]}]}}},T={args:{config:{...s,configMode:"simple",direction:"ascending",quantity:5,skip:{mode:"by",step:2,start:2},range:{min:2,max:10},tileBankMode:"exact",totalRounds:1,rounds:[{sequence:[2,4,6,8,10]}],levelMode:{generateNextLevel:P({start:2,step:2,quantity:5,direction:"ascending"})}}}},B={args:{config:{...s,configMode:"simple",direction:"ascending",quantity:3,skip:{mode:"by",step:5,start:5},range:{min:5,max:15},tileBankMode:"exact",totalRounds:1,rounds:[{sequence:[5,10,15]}],levelMode:{maxLevels:3,generateNextLevel:P({start:5,step:5,quantity:3,direction:"ascending"})}}}},w={args:{config:{...s,configMode:"simple",direction:"descending",quantity:4,skip:{mode:"by",step:3,start:3},range:{min:3,max:12},tileBankMode:"exact",totalRounds:1,rounds:[{sequence:[3,6,9,12]}],levelMode:{generateNextLevel:P({start:3,step:3,quantity:4,direction:"descending"})}}}},I={...s,totalRounds:1,quantity:10,range:{min:1e3,max:1e4},distractors:{source:"random",count:0},rounds:[{sequence:[1e3,2e3,3e3,4e3,5e3,6e3,7e3,8e3,9e3,1e4]}]},C={args:{config:I}},E={args:{config:I},parameters:{viewport:{defaultViewport:"mobileLg"}}},D={args:{config:I},parameters:{viewport:{defaultViewport:"tabletPortrait"}}},N={args:{config:I},parameters:{viewport:{defaultViewport:"desktop"}}};M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:"{}",...M.parameters?.docs?.source}}};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  args: {
    config: {
      ...baseConfig,
      skip: {
