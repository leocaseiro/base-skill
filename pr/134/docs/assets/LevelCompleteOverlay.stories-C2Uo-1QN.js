import{L as d}from"./LevelCompleteOverlay-Bb1Y5VTU.js";import"./iframe-B1F1jizC.js";import"./preload-helper-PPVm8Dsz.js";import"./confetti.module-oQXWb4Lk.js";const{expect:i,fn:c,userEvent:v,waitFor:m,within:p}=__STORYBOOK_MODULE_TEST__,L={component:d,title:"answer-game/LevelCompleteOverlay",tags:["autodocs"],args:{level:1,onNextLevel:c(),onDone:c()},argTypes:{level:{control:{type:"range",min:1,max:20,step:1}},onNextLevel:{table:{disable:!0}},onDone:{table:{disable:!0}}}},e={args:{level:1}},a={args:{level:3}},n={args:{level:10}},s={args:{level:1},play:async({args:r,canvasElement:o})=>{const l=p(o);await v.click(await l.findByRole("button",{name:/next level/i})),await m(()=>{i(r.onNextLevel).toHaveBeenCalledTimes(1)})}},t={args:{level:1},play:async({args:r,canvasElement:o})=>{const l=p(o);await v.click(await l.findByRole("button",{name:/done/i})),await m(()=>{i(r.onDone).toHaveBeenCalledTimes(1)})}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    level: 1
  }
