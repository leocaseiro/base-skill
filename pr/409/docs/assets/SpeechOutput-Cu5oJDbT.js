import{r as h,j as e,B as s}from"./iframe-mRk4Vqn9.js";import{u as r,M as l}from"./blocks-BlKfYdUR.js";import{a as o,s as a,c as x}from"./SpeechOutput-BwPda79X.js";import{I as p}from"./input-BoxfSLdF.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DrFu-skq.js";import"./safe-get-voices-dEfMv828.js";const i=()=>{const[t,n]=h.useState("Hello, world!");return o()?e.jsxs("div",{className:"flex flex-col gap-3 p-4",children:[e.jsx(p,{value:t,onChange:d=>n(d.target.value),placeholder:"Text to speak","aria-label":"Text to speak"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx(s,{onClick:()=>a(t),children:"Speak"}),e.jsx(s,{variant:"outline",onClick:x,children:"Cancel"})]})]}):e.jsx("p",{className:"text-muted-foreground text-sm",children:"Speech synthesis is not available in this browser."})};i.__docgenInfo={description:"",methods:[],displayName:"SpeechOutputDemo"};function c(t){const n={code:"code",h1:"h1",h2:"h2",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...r(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
