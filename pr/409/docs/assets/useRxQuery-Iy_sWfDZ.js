import{r,j as e,B as c}from"./iframe-mRk4Vqn9.js";import{u as i,M as x}from"./blocks-BlKfYdUR.js";import{u as d}from"./useRxQuery-GEnKYJbQ.js";import{S as m}from"./Subject-xajlhXoF.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DrFu-skq.js";const h=({source$:t})=>{const n=d(t,0);return e.jsx("p",{className:"text-2xl font-bold tabular-nums",children:n})},u=()=>{const[t]=r.useState(()=>new m),n=r.useMemo(()=>t.asObservable(),[t]),s=r.useRef(0),a=()=>{s.current+=1,t.next(s.current)},l=()=>{s.current=0,t.next(0)};return e.jsx("div",{className:"flex flex-col gap-3 p-4",children:e.jsxs("div",{className:"flex flex-wrap items-center gap-3",children:[e.jsx(h,{source$:n}),e.jsxs("div",{className:"flex flex-wrap gap-2",children:[e.jsx(c,{type:"button",onClick:a,children:"Increment"}),e.jsx(c,{type:"button",variant:"outline",onClick:l,children:"Reset"})]})]})})};u.__docgenInfo={description:"",methods:[],displayName:"UseRxQueryDemo"};function o(t){const n={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...i(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
