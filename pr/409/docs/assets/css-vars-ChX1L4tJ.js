import{j as e}from"./iframe-mRk4Vqn9.js";import{u as r,M as c}from"./blocks-BlKfYdUR.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DrFu-skq.js";function d(s){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...r(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
...
`,e.jsxs(n.table,{children:[`
  ...
  `,e.jsxs(n.tbody,{children:[`
    ...
    `]}),`
  `]})]})]})}function o(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(d,{...s})}):d(s)}export{o as default};
