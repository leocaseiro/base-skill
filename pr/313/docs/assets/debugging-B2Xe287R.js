import{j as e}from"./iframe-r0ZUGysq.js";import{u as t,M as r}from"./blocks-BOiXcH2v.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B8d39A_m.js";import"./index-BZizj7lz.js";import"./index-DglVFGdo.js";import"./index-DpySWgxT.js";import"./index-DrFu-skq.js";function i(s){const n={blockquote:"blockquote",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"GameEngine/Debugging"}),`
...
`,e.jsxs(n.blockquote,{children:[`
  `,e.jsxs(n.p,{children:[`
    `,e.jsx(n.strong,{children:"Note:"})," this snippet relies on ",e.jsx(n.code,{children:"answer-game-reducer"}),`, which is removed in
    PR 1c. The XState-first engine replaces it (see §5 above and §9 for the
    overlay invariant). For new tests, drive `,e.jsx(n.code,{children:"wordSpellMachine"}),` /
    `,e.jsx(n.code,{children:"sortNumbersMachine"})," / ",e.jsx(n.code,{children:"numberMatchMachine"})," directly via ",e.jsx(n.code,{children:"createActor(...)"}),`
    — see the `,e.jsx(n.code,{children:"definition.test.ts"}),` files for the canonical pattern. Kept here
    as a historical reference until PR 1c lands.
  `]}),`
`]}),`
...
`,e.jsxs(n.ol,{children:[`
  ...
  `,e.jsxs(n.li,{children:[`
    ...
    was removed in PR 1b — sounds now fire from machine `,e.jsx(n.code,{children:"entry"}),`
    actions and overlays gate directly on `,e.jsx(n.code,{children:"engine.phase"}),`.
  `]}),`
  `,e.jsxs(n.li,{children:[`
