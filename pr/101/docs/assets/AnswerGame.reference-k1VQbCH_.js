import{j as e}from"./iframe-DvQJ8Mk7.js";import{u as r,M as c}from"./blocks-DTC2slmO.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B2k684QV.js";import"./index-BKQhzlaK.js";import"./index-nJjTmQLD.js";import"./index-Nm8rC2ZS.js";import"./index-DrFu-skq.js";function s(d){const n={blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...d.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"answer-game/Reference"}),`
...
`,e.jsxs(n.table,{children:[`
  ...
  `,e.jsxs(n.tbody,{children:[`
    `,e.jsxs(n.tr,{children:[`
      ...
      `,e.jsxs(n.td,{children:[e.jsx(n.code,{children:"AnswerGameProvider"})," (mount effect)"]}),`
      `,e.jsx(n.td,{children:"Resets round state, populates tiles and zones"}),`
    `]}),`
    `,e.jsxs(n.tr,{children:[`
...
`})}),`
`,e.jsxs(n.p,{children:[`
  `,"The provider also supplies ",e.jsx(n.code,{children:"GameRoundContext"})," with ",e.jsx(n.code,{children:"{ current: number, total: number }"}),`
...
`,e.jsxs(n.table,{children:[`
  ...
  `,e.jsxs(n.tbody,{children:[`
    ...
    `]}),`
    `,e.jsxs(n.tr,{children:[`
      `,e.jsx(n.td,{children:e.jsx(n.code,{children:"skin"})}),`
      `,e.jsx(n.td,{children:e.jsx(n.code,{children:"string"})}),`
      `,e.jsx(n.td,{children:e.jsx(n.code,{children:"'classic'"})}),`
      `,e.jsxs(n.td,{children:["Skin id. Resolved by ",e.jsx(n.code,{children:"useGameSkin(gameId, skin)"}),"; controls CSS token values on the ",e.jsx(n.code,{children:"game-container"})," wrapper"]}),`
    `]}),`
  `]})]}),`
`,e.jsx(n.hr,{}),`
`,e.jsx(n.h2,{id:"skin-integration",children:"Skin integration"}),`
`,e.jsxs(n.p,{children:[`
  `,e.jsx(n.code,{children:"Slot"}),", ",e.jsx(n.code,{children:"LetterTileBank"}),", ",e.jsx(n.code,{children:"SortNumbersTileBank"}),", and ",e.jsx(n.code,{children:"NumeralTileBank"}),` are
  token-driven. They read a single set of CSS custom properties (published by
  `,e.jsx(n.code,{children:"classicSkin"}),` and overridable per game skin):
`]}),`
`,e.jsxs(n.ul,{children:[`
  `,e.jsxs(n.li,{children:[`
    `,e.jsx(n.strong,{children:"Tile surface:"})," ",e.jsx(n.code,{children:"tileStyle()"})," in ",e.jsx(n.code,{children:"src/components/answer-game/styles.ts"}),`
    composes `,e.jsx(n.code,{children:"--skin-tile-surface"}),", ",e.jsx(n.code,{children:"--skin-tile-highlight"}),", ",e.jsx(n.code,{children:"--skin-tile-ring"}),`,
    `,e.jsx(n.code,{children:"--skin-tile-inset-top"}),", ",e.jsx(n.code,{children:"--skin-tile-inset-bottom"}),`,
    `,e.jsx(n.code,{children:"--skin-tile-text-shadow"})," into a single ",e.jsx(n.code,{children:"CSSProperties"}),` object applied to
    every draggable tile button.
  `]}),`
  `,e.jsxs(n.li,{children:[`
    `,e.jsx(n.strong,{children:"Slot state:"})," ",e.jsx(n.code,{children:"Slot"})," merges ",e.jsx(n.code,{children:"baseStyle"})," with ",e.jsx(n.code,{children:"--skin-correct-*"}),`,
    `,e.jsx(n.code,{children:"--skin-wrong-*"}),", and ",e.jsx(n.code,{children:"--skin-hover-border-*"}),` tokens — there is no
    `,e.jsx(n.code,{children:"isCustomSkin"}),` branch; classic and custom skins walk the same code path.
  `]}),`
  `,e.jsxs(n.li,{children:[`
    `,e.jsx(n.strong,{children:"Bank holes & hover previews:"})," ",e.jsx(n.code,{children:"--skin-bank-hole-bg"}),`,
    `,e.jsx(n.code,{children:"--skin-bank-hole-shadow"}),", ",e.jsx(n.code,{children:"--skin-hover-border-color"}),`,
    `,e.jsx(n.code,{children:"--skin-hover-border-style"}),`.
  `]}),`
  `,e.jsxs(n.li,{children:[`
    `,e.jsx(n.strong,{children:"Sentence-with-gaps underline:"})," ",e.jsx(n.code,{children:"--skin-sentence-gap-border"}),`,
    `,e.jsx(n.code,{children:"--skin-sentence-gap-style"}),`.
  `]}),`
  `,e.jsxs(n.li,{children:[`
    `,e.jsx(n.strong,{children:"Question components:"})," ",e.jsx(n.code,{children:"AudioButton"}),", ",e.jsx(n.code,{children:"TextQuestion"}),", ",e.jsx(n.code,{children:"EmojiQuestion"}),`,
    `,e.jsx(n.code,{children:"ImageQuestion"}),", ",e.jsx(n.code,{children:"DotGroupQuestion"}),` read
    `,e.jsx(n.code,{children:"--skin-question-bg|text|radius|audio-bg|audio-fg|dot-bg|dot-assigned-bg"}),`.
  `]}),`
  `,e.jsxs(n.li,{children:[`
    `,e.jsx(n.strong,{children:"Domino pips (NumberMatch):"})," ",e.jsx(n.code,{children:"--skin-pip-color"}),`,
    `,e.jsx(n.code,{children:"--skin-pip-divider-color"}),", ",e.jsx(n.code,{children:"--skin-pip-divider-opacity"}),`.
  `]}),`
`]}),`
`,e.jsx(n.p,{children:"Games set the container once:"}),`
...
`})}),`
`,e.jsx(n.p,{children:"Any token not set in a custom skin cascades through to the classic default."})]})}function u(d={}){const{wrapper:n}={...r(),...d.components};return n?e.jsx(n,{...d,children:e.jsx(s,{...d})}):s(d)}export{u as default};
