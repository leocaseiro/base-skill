import{j as e}from"./iframe-0-GSJzeg.js";import{u as r,M as c}from"./blocks-DyTycWLt.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DrFu-skq.js";function s(d){const n={blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...d.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"AnswerGame/Reference"}),`
...
`,e.jsxs(n.table,{children:[`
  ...
  `,e.jsxs(n.tbody,{children:[`
    ...
    `]}),`
    `,e.jsxs(n.tr,{children:[`
      `,e.jsx(n.td,{children:e.jsx(n.code,{children:"useGameTTS"})}),`
      `,e.jsx(n.td,{children:e.jsx(n.code,{children:"useGameTTS.ts"})}),`
      `,e.jsxs(n.td,{children:["Returns ",e.jsx(n.code,{children:"{ speakTile, speakPrompt, speakPromptOnDemand }"})," — TTS surface for games"]}),`
      `,e.jsx(n.td,{children:"—"}),`
    `]}),`
  `]})]}),`
`,e.jsx(n.hr,{}),`
`,e.jsxs(n.h2,{id:"tts-surface-usegametts",children:["TTS Surface (",e.jsx(n.code,{children:"useGameTTS"}),")"]}),`
`,e.jsxs(n.p,{children:[`
  `,"The ",e.jsx(n.code,{children:"useGameTTS"}),` hook returns three callbacks with three distinct
  voice-availability semantics. The user notification mechanism differs
  per-callback by intent:
`]}),`
`,e.jsxs(n.table,{children:[`
  `,e.jsxs(n.thead,{children:[`
    `,e.jsxs(n.tr,{children:[`
      `,e.jsx(n.th,{children:"Callback"}),`
      `,e.jsx(n.th,{children:"When to use"}),`
      `,e.jsx(n.th,{children:"Preferred voice unavailable → behaviour"}),`
    `]}),`
  `]}),`
  `,e.jsxs(n.tbody,{children:[`
    `,e.jsxs(n.tr,{children:[`
      `,e.jsx(n.td,{children:e.jsx(n.code,{children:"speakTile"})}),`
      `,e.jsx(n.td,{children:"Auto playback on tile interactions (drag pickup, tile reads)"}),`
      `,e.jsxs(n.td,{children:["Silent fallback to the OS default voice; global ",e.jsx(n.code,{children:"VoiceUnavailableWarning"})," banner informs the user."]}),`
    `]}),`
    `,e.jsxs(n.tr,{children:[`
      `,e.jsx(n.td,{children:e.jsx(n.code,{children:"speakPrompt"})}),`
      `,e.jsx(n.td,{children:"Auto playback at round start / auto-trigger paths"}),`
      `,e.jsx(n.td,{children:"Silent return — does NOT play with the OS default; banner informs the user."}),`
    `]}),`
    `,e.jsxs(n.tr,{children:[`
      `,e.jsx(n.td,{children:e.jsx(n.code,{children:"speakPromptOnDemand"})}),`
      `,e.jsx(n.td,{children:"User-initiated speak actions (audio button, tile tap)"}),`
      `,e.jsxs(n.td,{children:["Opens the ",e.jsx(n.code,{children:"VoiceUnavailableDialogProvider"})," AlertDialog so the user can fix the configuration immediately."]}),`
    `]}),`
  `]})]}),`
`,e.jsxs(n.p,{children:[`
  `,"The global ",e.jsx(n.code,{children:"VoiceUnavailableWarning"})," banner (mounted in ",e.jsx(n.code,{children:"_app.tsx"}),`) is the
  ambient notification surface. The `,e.jsx(n.code,{children:"VoiceUnavailableDialogProvider"}),` AlertDialog
  (also mounted in `,e.jsx(n.code,{children:"_app.tsx"}),`) is the on-demand notification surface that interrupts
  the user flow only when they explicitly triggered a speak action.
`]}),`
`,e.jsx(n.hr,{}),`
...
`})}),`
`,e.jsx(n.h3,{id:"provider-props",children:"Provider props"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`<AnswerGameProvider
  config={AnswerGameConfig}
  initialState={AnswerGameDraftState | undefined}
  sessionId={string | undefined}
  engineDispatch={(action) => void | undefined}
>
  {children}
</AnswerGameProvider>
`})}),`
`,e.jsxs(n.p,{children:[`
  `,"PR 1a adds the optional ",e.jsx(n.code,{children:"engineDispatch"}),` prop. When set, every reducer
  dispatch — including the provider's own mount-effect `,e.jsx(n.code,{children:"INIT_ROUND"}),` /
  `,e.jsx(n.code,{children:"RESUME_ROUND"})," plus every ",e.jsx(n.code,{children:"PLACE_TILE"})," / ",e.jsx(n.code,{children:"TYPE_TILE"}),` / etc. from
  `,e.jsx(n.code,{children:"Slot"}),", ",e.jsx(n.code,{children:"NumeralTileBank"}),", ",e.jsx(n.code,{children:"useKeyboardInput"}),", and ",e.jsx(n.code,{children:"useTouchKeyboardInput"}),`
  — is mirrored to `,e.jsx(n.code,{children:"engineDispatch"}),`. XState-first games (NumberMatch in
  PR 1a; WordSpell + SortNumbers in PR 1b; SpotAll in PR 1d) pass their
  `,e.jsx(n.code,{children:"useGameEngine(...).send"})," (wrapped in a stable callback via ",e.jsx(n.code,{children:"useRef"}),`)
  so the per-game XState machine receives the same events as the reducer.
  PR 1c removes the reducer; until then, both run in parallel and the
  dispatch bridge keeps them in sync.
`]}),`
`,e.jsxs(n.p,{children:[`
  `,"The wrapped dispatch is built with ",e.jsx(n.code,{children:"useCallback"}),` (empty deps) and reads
  the latest `,e.jsx(n.code,{children:"engineDispatch"})," via a ",e.jsx(n.code,{children:"useRef"}),`, so its identity is stable
  even when the engine's `,e.jsx(n.code,{children:"send"}),` is recreated on each machine state
  transition. Stable dispatch identity prevents the mount-effect from
  re-firing `,e.jsx(n.code,{children:"INIT_ROUND"}),"/",e.jsx(n.code,{children:"RESUME_ROUND"}),` when the engine changes.
`]}),`
...
`,e.jsxs(n.table,{children:[`
  ...
  `,e.jsxs(n.tbody,{children:[`
    ...
    `]}),`
  `]})]})]})}function h(d={}){const{wrapper:n}={...r(),...d.components};return n?e.jsx(n,{...d,children:e.jsx(s,{...d})}):s(d)}export{h as default};
