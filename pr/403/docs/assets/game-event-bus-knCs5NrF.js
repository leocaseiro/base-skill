import{r as i,N as p,j as e,B as r}from"./iframe-0-GSJzeg.js";import{u as a,M as v}from"./blocks-DyTycWLt.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DrFu-skq.js";const c={gameId:"demo",sessionId:"demo-session",profileId:"anonymous",timestamp:Date.now(),roundIndex:0},l=()=>{const t=i.useRef(p()),[n,m]=i.useState([]);i.useEffect(()=>t.current.subscribe("game:*",d=>{m(j=>[`[${d.type}] ${JSON.stringify(d)}`,...j.slice(0,9)])}),[]);const u=()=>{const s={type:"game:start",...c,locale:"en",difficulty:"easy",gradeBand:"k"};t.current.emit(s)},h=()=>{const s={type:"game:end",...c,finalScore:0,totalRounds:1,correctCount:0,durationMs:0,retryCount:0};t.current.emit(s)},x=()=>{const s={type:"game:instructions_shown",...c};t.current.emit(s)};return e.jsxs("div",{className:"flex flex-col gap-4 p-4",children:[e.jsxs("div",{className:"flex flex-wrap gap-2",children:[e.jsx(r,{size:"sm",onClick:u,children:"Emit game:start"}),e.jsx(r,{size:"sm",onClick:h,children:"Emit game:end"}),e.jsx(r,{size:"sm",onClick:x,children:"Emit game:instructions_shown"})]}),e.jsx("div",{className:"rounded border p-2 font-mono text-xs",children:n.length===0?e.jsx("span",{className:"text-muted-foreground",children:"No events yet — click a button above."}):n.map(s=>e.jsx("div",{children:s},s))})]})};l.__docgenInfo={description:"",methods:[],displayName:"GameEventBusDemo"};function o(t){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
...
`]}),`
`,e.jsx(n.h2,{id:"interactive-demo",children:"Interactive Demo"}),e.jsx(l,{})]})}function y(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{y as default};
