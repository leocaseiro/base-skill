...
.cave-dragon-scene__bg-middle {
  position: absolute;
  inset: 0;
  background-image: url('${o}/bg-middle.png');
...
.cave-dragon-scene__dragon {
  ...
  width: 14%;
  height: 38%;
  background-image: url('${o}/dragon.png');
...
}`,...s.parameters?.docs?.source}}};const he=["Default","HUD_Round2Of5","HUD_Round5Of5"];export{r as Default,n as HUD_Round2Of5,s as HUD_Round5Of5,he as __namedExportsOrder,ue as default};
