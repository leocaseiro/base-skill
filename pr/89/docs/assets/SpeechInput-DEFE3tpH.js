...
`,e.jsxs(n.table,{children:[`
  ...
  `,e.jsxs(n.tbody,{children:[`
    ...
    `]}),`
  `]})]}),`
`,e.jsx(n.h2,{id:"interactive-demo",children:"Interactive Demo"}),e.jsx(h,{})]})}function M(t={}){const{wrapper:n}={...d(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(l,{...t})}):l(t)}export{M as default};
